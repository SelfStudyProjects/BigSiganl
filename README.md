...
# BigSignal - 실시간 암호화폐 시그널 분석 플랫폼

🌐 **Live Demo**: https://bigsignal-dd31f.web.app
🔧 **API Backend**: https://bigsignal-backend.onrender.com
📊 **Analysis Dashboard**: https://bigsignal-dd31f.web.app/analysis

## 최신 운영 현황 (2025-10-05)
- 수집된 거래: 814개
- 분석 기간: 59일
- 활성 포트폴리오: 7개
- 최고 성과: DOGE_Only (+4.68%)

## 배포 아키텍처

(아래에 있는 시스템 아키텍처 섹션과 연동됩니다 — 프론트엔드(Firebase Hosting), 백엔드(Django on Render/AWS), DB(Postgres)로 구성되어 있습니다.)
